...
export const ParametrosObligatorios: () => JSX.Element = () => {
  var {parametro1, parametro2} = useParams<string>(); //El hook "useParams" permite obtener los parámetros que llegan desde la URL.
